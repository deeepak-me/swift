...
`,cv=y.div`
  display: flex;
  gap: 16px;
`,dv=({blog:e})=>u.jsx(rv,{children:u.jsxs(iv,{children:[u.jsx(ov,{children:u.jsx("img",{src:e.image})}),u.jsxs(lv,{children:[u.jsx(sv,{children:"NEW PRODUCT"}),u.jsx(av,{children:e.title}),u.jsx(uv,{children:e.about}),u.jsx(cv,{children:u.jsx(Ge,{children:"SEE PRODUCT"})})]})]})}),Ma=({blogs:e})=>u.jsx("div",{children:e.map(t=>u.jsx(dv,{blog:t}))}),fv=()=>{const[e,t]=P.useState([{image:Ho,title:"XX99 Mark I Headphones",about:"The new XX99 Mark II headphones is the pinnacle of pristine audio.It redefines your premium headphone experience by reproducing the balanced depth and precision of studio-quality sound.",price:"$ 2,999"},{image:P1,title:"XX59 Headphones",about:"Enjoy your audio almost anywhere and customize it to your specific tastes with the XX59 headphones. The stylish yet durable versatile wireless headset is a brilliant companion at home or on the move.",price:"$ 2,999"},{image:_1,title:"XX59 Headphones",about:"Enjoy your audio almost anywhere and customize it to your specific tastes with the XX59 headphones. The stylish yet durable versatile wireless headset is a brilliant companion at home or on the move.",price:"$ 2,999"}]);return u.jsxs("div",{children:[u.jsx(qn,{}),u.jsx(La,{title:"HEADPHONES"}),u.jsx(Ma,{blogs:e}),u.jsx(ni,{}),u.jsx(ti,{}),u.jsx(bn,{})]})},pv="/swift/assets/earbuds2-a9290fbf.png",hv="/swift/assets/Bitmap1-3378b10b.png",mv="/swift/assets/Bitmap2-dc0cdd34.png",gv="/swift/assets/Bitmap3-d2a16b93.png",yv=y.div`
  display: flex;
  justify-content: center;
  align-items: center;
  margin-bottom: 160px;
...
`,Jv=y(Jn)`
  ...
  letter-spacing: 1px;
  text-transform: uppercase;
`,qv=()=>(P.useEffect(()=>{const e=document.querySelector("#app");if(e)return e.style="height: 125vh; overflow: hidden;",()=>{e.style=""}},[]),u.jsx(Fv,{children:u.jsxs(Uv,{children:[u.jsxs(Vv,{children:[u.jsx("img",{src:Av}),u.jsxs(Bv,{children:["THANK YOU ",u.jsx("br",{}),"FOR YOUR ORDER"]}),u.jsx(Hv,{children:"You will receive an email confirmation shortly."})]}),u.jsxs(Wv,{children:[u.jsxs(Xv,{children:[u.jsx(Bi,{}),u.jsx(Qv,{}),u.jsx(Kv,{children:"and 2 other item(s)"})]}),u.jsxs(Yv,{children:[u.jsx(Gv,{children:"GRAND TOTAL"}),u.jsx(Zv,{children:" $5987 "})]})]}),u.jsx(Ge,{children:u.jsx(Jv,{to:"/swift",children:"BACK TO HOME"})})]})})),bv=()=>{const[e,t]=P.useState([{image:pv,title:"YX1 WIRELESS EARPHONES",about:"Tailor your listening experience with bespoke dynamic drivers from the new YX1 Wireless Earphones. Enjoy incredible high-fidelity sound even in noisy environments with its active noise cancellation feature.",price:"$ 2,999"}]);return u.jsxs("div",{children:[u.jsx(qn,{}),u.jsx(La,{title:"EARPHONES"}),u.jsx(Ma,{blogs:e}),u.jsx(ni,{}),u.jsx(ti,{}),u.jsx(bn,{})]})},ex="/swift/assets/speaker4-ffd09abb.png",tx="/swift/assets/speaker5-b87f0699.png";function nx(){const[e,t]=P.useState([{image:ex,title:"ZX9 SPEAKER",about:"Upgrade your sound system with the all new ZX9 active speaker. It’s a bookshelf speaker system that offers truly wireless connectivity -- creating new possibilities for more pleasing and practical audio setups.",price:"$ 2,999"},{image:tx,title:"ZX7 SPEAKER",about:"Stream high quality sound wirelessly with minimal loss. The ZX7 bookshelf speaker uses high-end audiophile components that represents the top of the line powered speakers for home or studio use.",price:"$ 2,999"}]);return u.jsxs("div",{children:[u.jsx(qn,{}),u.jsx(La,{title:"SPEAKERS"}),u.jsx(Ma,{blogs:e}),u.jsx(ni,{}),u.jsx(ti,{}),u.jsx(bn,{})]})}const rx=y.div`
  background: #f1f1f1;
`,ix=y.div`
  padding-top: 145px;
  padding-left: 120px;
